...
export function ProfuzionFooter() {
  ...
  return (
    <footer
      ...
      style={{ background: "var(--p-void)", color: "var(--p-ink)" }}
    >
      <div className="mx-auto max-w-[1480px] px-6 pt-24 pb-10 lg:px-10 lg:pt-32 lg:pb-12">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-end lg:justify-between">
          ...
          >
            ...
            <li style={{ color: "var(--p-amber)" }}>{studio.availability}</li>
          </ul>
        </div>

        {/* Rule */}
        <div className="my-12 p-rule p-rule--ink lg:my-16" />
        ...
        {items.map((it) => (
          <li key={it.href}>
            ...
            >
              ...
              />
              <span className="transition-colors duration-200 group-hover:text-[color:var(--p-amber)]">
                {it.label}
              </span>
            </a>
          </li>
