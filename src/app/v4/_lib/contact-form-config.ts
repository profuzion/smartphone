 ...
 * WordPress server. This preview stack cannot execute shortcodes, so for production
 * you typically:
 *
 ...
 *
 * If neither is set, the in-repo contact form runs (demo: simulated submit) or you
