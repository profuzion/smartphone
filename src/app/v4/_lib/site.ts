...
export const phases: readonly Phase[] = [
  ...
  },
  {
    ...
    body: "Built to modern performance standards, tuned for Core Web Vitals, structured for AI search and Google. We hand over a site you can update without us.",
    bullets: [
