...
export function SectionFounder() {
  ...
  useGSAP(
    () => {
      ...
      // Counter-parallax — portrait drifts down while copy drifts up,
      // so the two columns slide past each other as you scroll. The
      // image inside the portrait frame parallaxes opposite to the
      // frame so the photo "settles" inside its mat as you scroll.
      gsap.fromTo(
        "[data-founder-visual]",
        { yPercent: -6 },
        {
    ...
    >
      ...
      <div className="mx-auto max-w-[1480px] px-6 py-24 lg:px-10 lg:py-32">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16">
          ...
          {/* Copy */}
          <div data-founder-copy className="order-1 max-w-xl lg:order-2">
